...
2. **Consume and reflect daily**: every day before the cutoff (2:30 AM, adjustable in Ajustes), log what you consumed; the words of all the day's notes add up to the goal (50 by default), and today's notes can be reopened and continued. Long videos are tracked by resume position and chapters. You write next to the material: the note editor lives on the same screen as the player, the mystery box and the topic sheet, and saving it leaves you exactly where you were. `/registrar` is for writing about something that is not saved anywhere, and is reached from Hoy.
...
4. **Discovery**: a daily mystery box reveals one nourishing topic (not trivia) to research, and the topics you pick for yourself get a researched sheet of their own: curious facts with sources, a timeline, the words you need, and what to read or watch next. What you save from the box or a sheet stays on that screen, ready to play, instead of throwing you into the library.
